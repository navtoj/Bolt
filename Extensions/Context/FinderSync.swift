...
class FinderSync: FIFinderSync {
	...
	override var toolbarItemToolTip: String {
		"FinderSy: Click the toolbar item for a menu."
	}
	...
	var myFolderURL = URL(fileURLWithPath: "/Users/navtoj/Developer/Container/Extension")
	...
	@IBAction
	func sampleAction(_ sender: AnyObject?) {
